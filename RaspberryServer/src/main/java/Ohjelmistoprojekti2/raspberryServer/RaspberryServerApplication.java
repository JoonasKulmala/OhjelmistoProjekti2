...
public class RaspberryServerApplication {
	...
	public CommandLineRunner productDemo(RaspberryRepository rRepo, TimeStampRepository tRepo, ResultRepository xRepo,
		...
		return (args) -> {
			...
			rRepo.save(new Raspberry("Suomenlinna",10, "60.1454", "24.98814", "http://materialbank.myhelsinki.fi/deployedFiles/6559a1a744601093ae355f8d05e3a896.jpg", "Suomenlinnan eteläinen sisäänkäynti", "Mon Sep 28 10:54:43 2020"));
			...
			// Mockup data to simulate 'Timestamp'
			 tRepo.save(new TimeStamp("13:00", 0, rRepo.findByLocation("Suomenlinna").get(0)));
			 tRepo.save(new TimeStamp("Mon Sep 28 12:30:00 2020", 0, rRepo.findByLocation("Suomenlinna").get(0)));
			 tRepo.save(new TimeStamp("Mon Sep 28 13:00:00 2020", 0, rRepo.findByLocation("Suomenlinna").get(0)));
			 tRepo.save(new TimeStamp("Mon Sep 28 13:30:00 2020", 0, rRepo.findByLocation("Suomenlinna").get(0)));
