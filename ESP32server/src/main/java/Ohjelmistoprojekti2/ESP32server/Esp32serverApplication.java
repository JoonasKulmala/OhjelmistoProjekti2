...
public class Esp32serverApplication {
	...
	public CommandLineRunner productDemo(RaspberryRepository raspberryRepository) {
		return(args) ->{
			...
			Raspberry sibeliusmonumentti = new Raspberry("11:0a:95:3d:69:22", "Sibelius-monumentti");
			Raspberry rautatieasema = new Raspberry("32:5a:15:5d:65:16", "Rautatieasema");
			Raspberry presidentinlinna = new Raspberry("54:1a:22:5d:65:88", "Presidentinlinna");
			Raspberry temppeliaukionKirkko = new Raspberry("01:0a:25:5a:75:16", "Temppeliaukion kirkko");
			Raspberry helsinginTuomiokirkko = new Raspberry("11:1a:11:1d:11:11", "Helsingin tuomiokirkko");
			Raspberry kauppatori = new Raspberry("22:6a:33:1a:65:16", "Kauppatori");
			Raspberry senaatintori = new Raspberry("98:7a:65:4d:32:10", "Senaatintori");
